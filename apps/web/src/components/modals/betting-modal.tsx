...
export function BettingModal({ app, onClose, onSuccess, isOpen }: BettingModalProps) {
  ...
  return (
    <ModalWrapper onClose={onClose} title="Betting Temporarily Disabled">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          We&apos;re expanding MiniHunt with exciting new features! Voting is temporarily paused while we work on improvements. Claim functionality remains available.
        </p>
        <Button
          variant="ghost"
