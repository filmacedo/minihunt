                  ...
                  <div className="pt-4 flex justify-between items-end">
                    ...
                    <div className="text-right">
                      ...
                      <div className="font-mono text-foreground text-lg text-[#E1FF00] dark:text-[#E1FF00] text-green-600">
                        {formatEther(currentEarned)} CELO
                      </div>
                    </div>
                  </div>
                </>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                         <span className={cn("font-mono text-sm", isWinner ? "text-[#E1FF00] dark:text-[#E1FF00] text-green-600" : "text-muted-foreground")}>
                           {isWinner ? `+${formatEther(earned)} CELO` : "No Win"}
                         </span>
                         <Icons.ChevronRight
                           className={cn(
                    ...
                    {isExpanded && (
                      <div className="px-4 pb-4 pt-0">
                         <div className="pt-4 border-t border-border/50 flex justify-between">
                            ...
                            <span className="font-mono text-foreground">{formatEther(spent)} CELO</span>
                         </div>
                         <div className="pt-2 flex justify-between">
                            <span className="text-muted-foreground">Total Earned:</span>
                            <span className="font-mono text-foreground">{formatEther(earned)} CELO</span>
                         </div>
                      </div>
                    )}
                  </div>
