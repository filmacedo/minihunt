...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "MiniHunt. Bet on the best miniapps.", // 30 characters, no emojis or special characters, short description under app name
      description: "MiniHunt. Bet on the best miniapps.", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "MiniHunt. Bet on the best miniapps.", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
