...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "Bet on the best miniapps.", // 30 characters, no emojis or special characters, short description under app name
      description:
        "Vote on your favorite miniapps and win. Early votes earn the biggest rewards.", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      primaryCategory: "social",
      tags: ["miniapps", "betting", "leaderboard"], // up to 5 tags, filtering/search tags
      tagline: "Bet on the best miniapps.", // 30 characters, marketing tagline should be punchy and descriptive
      ogTitle: `${frameName}`, // 30 characters, app name + short tag, Title case, no emojis
      ogDescription:
        "Vote on your favorite miniapps and win. Early votes earn the biggest rewards.", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
